...
const WalletTransDetailView = () => {
  ...
  const cardEl = useCallback(
    (label: string | ReactNode, value: string | ReactNode) => {
      return (
        <div className="flex items-start justify-between text-xs mb-4 font-bold last:mb-0">
  ...
  return (
    ...
    >
      <div className="p-content">
        <div className="bg-bg1 rounded-md px-3.5 py-4">
          ...
          <div className="bg-white rounded-md px-3.5 py-4 mt-4">
            {cardEl(
