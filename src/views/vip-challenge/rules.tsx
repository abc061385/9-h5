...
const ChallengeRewardRules = () => {
  ...
  const columns = [
    ...
    {
      title: t("reward"),
      desc: `(USDT ${t("equivalentValue")} → USDM ${t("distribution")})`,
    },
  ];
  ...
  const data = [
    {
      ...
      challengeCycle: "20",
      pledge: "≥ 100,000 USDT",
      award: `1,000 USDT ${t("equivalentValue")} USDM`,
    },
    {
      currentLevel: "VIP2",
      targetLevel: "VIP5",
      challengeCycle: "25",
      pledge: "≥ 300,000 USDT",
      award: `3,000 USDT ${t("equivalentValue")} USDM`,
    },
    {
      currentLevel: "VIP3",
      targetLevel: "VIP6",
      ...
      award: `9,000 USDT ${t("equivalentValue")} USDM`,
    },
    {
      currentLevel: "VIP4",
      targetLevel: "VIP7",
      ...
      award: `27,000 USDT ${t("equivalentValue")} USDM`,
    },
    {
      currentLevel: "VIP5",
      targetLevel: "VIP8",
      ...
      award: `90,000 USDT ${t("equivalentValue")} USDM`,
    },
    {
      currentLevel: "VIP6",
      targetLevel: "VIP9",
      ...
      award: `270,000 USDT ${t("equivalentValue")} USDM`,
    },
    {
      currentLevel: "VIP7",
      targetLevel: "VIP9⭐️",
