 ...
 *   node csv2json.cjs input.csv zh_CN zh_HK en
  *  node csv2json.cjs ../export_lang/import_0924.csv en zh-Hans zh-Hant ja-JP ko-KR ms-MY th-TH vi-VN hi-IN de-DE fr-FR pt-PT es-ES nl-NL no-NO sv-SE ro-RO cs-CZ
